...
void main() async {
  ...
  await AppCenterSDK.configureDistributeDebugAsync(enabled: false);
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    AppCenterSDK.trackEventAsync('_MyAppState.initState');
  }
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FutureBuilder(
                future: AppCenterSDK.isCrashesEnabledAsync(),
              ...
              const SizedBox(height: 8.0),
              FutureBuilder(
                future: AppCenterSDK.isAnalyticsEnabledAsync(),
                builder: (_, AsyncSnapshot<bool?> snapshot) {
                  if (snapshot.hasData) {
              ...
              const SizedBox(height: 8.0),
              FutureBuilder(
                future: AppCenterSDK.isDistributeEnabledAsync(),
                builder: (_, AsyncSnapshot<bool?> snapshot) {
                  if (snapshot.hasData) {
