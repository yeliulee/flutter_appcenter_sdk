package io.github.yeliulee.flutter_appcenter_sdk
...
class FlutterAppcenterSDKPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        val channel = MethodChannel(flutterPluginBinding.binaryMessenger, methodChannelName)
        channel.setMethodCallHandler(FlutterAppcenterSDKPlugin())
    }
    ...
    // in the same class.
    companion object {
        const val methodChannelName = "flutter_appcenter_sdk"
