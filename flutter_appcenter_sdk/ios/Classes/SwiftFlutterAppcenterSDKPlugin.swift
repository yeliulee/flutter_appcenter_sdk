...
public class SwiftFlutterAppcenterSDKPlugin: NSObject, FlutterPlugin {
    static let methodChannelName = "flutter_appcenter_sdk";
    static let instance = SwiftFlutterAppcenterSDKPlugin();
